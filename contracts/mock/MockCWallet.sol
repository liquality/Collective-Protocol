...
/**
  ...
  */
contract NewCWallet is ICWallet, BaseAccount, TokenCallbackHandler, UUPSUpgradeable, Initializable {
     ...
     */
    function initialize(address theCollective, address theOperator) public virtual reinitializer(version) {
